...
public class PlusMultParser extends Parser {
	...
	public static class StartContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof PlusMultVisitor ) return ((PlusMultVisitor<? extends T>)visitor).visitStart(this);
	...
	public static class ExprContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof PlusMultVisitor ) return ((PlusMultVisitor<? extends T>)visitor).visitExpr(this);
			else return visitor.visitChildren(this);
		}
	}
